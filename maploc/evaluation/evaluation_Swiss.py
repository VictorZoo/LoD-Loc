...
from ..data import SwissDataModule
...
data_cfg_train = OmegaConf.load(Path(conf_data_dir.__file__).parent / "Swiss-EPFL.yaml")
...
def run(
    ...
    **kwargs,
    ...
    dataset = SwissDataModule(cfg.get("data", {}))
...
if __name__ == "__main__":
    ...
    parser.add_argument("--if_save", type=str, default=False)
